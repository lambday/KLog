...
ostream& operator<<(ostream& out, const HistogramClass& aHC) {
    return aHC.Output(out);
}
...
unsigned HistogramClass::Size()const {
    return mHistogram.size();
}

//---------------------------------------------------------------------------------

ostream& operator<<(ostream& out, const SecondOrderHistogramClass& aSOH) {
    return aSOH.Output(out);
}
...
unsigned SecondOrderHistogramClass::Size()const {
    return mSecondOrderHistogram.size();
}

//---------------------------------------------------------------------------------

ostream& operator<<(ostream& out, const ThirdOrderHistogramClass& aTOH) {
    return aTOH.Output(out);
}
...
unsigned ThirdOrderHistogramClass::Size()const {
    return mThirdOrderHistogram.size();
}
