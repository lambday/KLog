...
private:
  ...
  Dataset() { remapped_indices = false;};
...
public:
  ...
  const std::map<double,std::string>& get_sym_label(void) {return sym_label;}
  const std::map<std::string,double>& get_num_label(void) {return num_label;}
