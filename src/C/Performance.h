...
class BinaryClassifierReporter: public Reporter
{
 ...
 public:
  ...
  void report(std::ostream& os) {
    ...
    os.width(0); os << "           ";
    os.width(8); os << std::right << '+';
    os.width(8); os << std::right << '-' << std::endl;
    os.width(0); os << "Predicted +";
    os.width(8); os << std::right << tp;
    os.width(8); os << std::right << fp << std::endl;
    os.width(0); os << "          -";
    os.width(8); os << std::right << fn;
    os.width(8); os << std::right << tn << std::endl;
    os << std::endl;
    os.width(0);
 ...
 public:
  ...
  void report(std::ostream& os) {
    ...
    for (CTable_T::iterator f=contingency_table.begin(); f!=contingency_table.end(); ++f) {
      os.width(8); os << std::right << sym_label[f->first].substr(0,7);
    }
    os << std::endl;
    ...
    for (CTable_T::iterator f=contingency_table.begin(); f!=contingency_table.end(); ++f) {
      os.width(8); os << std::right << sym_label[f->first].substr(0,7);
      for (IntInt_T::iterator y=f->second.begin(); y!=f->second.end(); ++y) {
        os.width(8); os << std::right << y->second;
      }
