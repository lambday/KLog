...
public:
    ...
    AtomTerm(YAP_Atom atom) : Term(YAP_MkAtomTerm(atom)) {
        v = atom;
    }

    YAP_Atom operator()(void) const {
        return v;
    }

    std::string str(void) const {
        return YAP_AtomName(v);
    }
...
public:
    ...
    std::string str(void) const {
        return (tail ? (".(" + head->str() + "," + tail->str() + ")") : head->str());
    }
...
public:
    ...
    const std::vector<double>& get_list(void) const {
        return lst;
    }
...
public:
    ...
    int get_arity(void) const {
        return arity;
    }

    AtomTerm get_functor_name(void) const {
        return functor_name;
    }

    std::string get_functor_str(void) const {
        return YAP_AtomName(YAP_NameOfFunctor(functor));
    }
